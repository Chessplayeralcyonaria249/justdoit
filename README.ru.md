...
> Скилл для Codex, который превращает сырой запрос в понятный execution pack и спрашивает подтверждение перед запуском.

От [Ris](https://t.me/ris_ai) — канал про AI-разработку и вайбкодинг

![justdoit](./assets/justdoit.gif)

`justdoit` — это репозиторий с одним скиллом и одной главной задачей:
...
- для пользователей Codex, которые хотят меньше тех-шума и больше ясности
